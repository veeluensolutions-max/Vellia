...
export const Auth = {
    ...
    canAccessRoute(role, route) {
        const permissions = {
            ...
            manager: ["dashboard", "crm", "kanban", "proposals", "team", "goals", "services", "forecast", "inspections", "ai-agents"],
            seller: ["dashboard", "crm", "kanban", "proposals", "goals", "inspections", "ai-agents"]
        };
